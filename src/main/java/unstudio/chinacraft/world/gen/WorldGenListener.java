...
public class WorldGenListener{
    ...
    private final WorldGenCCOre WORLD_GEN_COPPER_ORE = new WorldGenCCOre(new int[]{0}, FeatureConfig.copperOreFrequency,64,0,8, ChinaCraft.copperOre);
    private final WorldGenCCOre WORLD_GEN_TIN_ORE = new WorldGenCCOre(new int[]{0},FeatureConfig.tinOreFrequency,64,0,8, ChinaCraft.tinOre);
    private final WorldGenCCOre WORLD_GEN_SILVER_ORE = new WorldGenCCOre(new int[]{0},FeatureConfig.silverOreFrequency,32,0,8, ChinaCraft.silverOre);
    private final WorldGenCCOre WORLD_GEN_JADE_ORE = new WorldGenCCOre(new int[]{0},FeatureConfig.jadeOreFrequency,64,32,4, ChinaCraft.jadeOre);
    private final WorldGenCCOre WORLD_GEN_MARBLE_ORE = new WorldGenCCOre(new int[]{0},FeatureConfig.marbleOreFrequency,128,32,48, ChinaCraft.blockMarble);
